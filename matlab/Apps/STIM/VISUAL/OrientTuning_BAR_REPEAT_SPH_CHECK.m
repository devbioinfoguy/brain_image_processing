function varargout = OrientTuning_BAR_REPEAT_SPH_CHECK(varargin)
% ORIENTTUNING_BAR_REPEAT_SPH_CHECK M-file for OrientTuning_BAR_REPEAT_SPH_CHECK.fig
%      ORIENTTUNING_BAR_REPEAT_SPH_CHECK, by itself, creates a new ORIENTTUNING_BAR_REPEAT_SPH_CHECK or raises the existing
%      singleton*.
%
%      H = ORIENTTUNING_BAR_REPEAT_SPH_CHECK returns the handle to a new ORIENTTUNING_BAR_REPEAT_SPH_CHECK or the handle to
%      the existing singleton*.
%

%      ORIENTTUNING_BAR_REPEAT_SPH_CHECK('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ORIENTTUNING_BAR_REPEAT_SPH_CHECK.M with the given input arguments.
%
%      ORIENTTUNING_BAR_REPEAT_SPH_CHECK('Property','Value',...) creates a new ORIENTTUNING_BAR_REPEAT_SPH_CHECK or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OrientTuning_BAR_REPEAT_SPH_CHECK_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OrientTuning_BAR_REPEAT_SPH_CHECK_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OrientTuning_BAR_REPEAT_SPH_CHECK

% Last Modified by GUIDE v2.5 22-Feb-2013 17:48:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OrientTuning_BAR_REPEAT_SPH_CHECK_OpeningFcn, ...
                   'gui_OutputFcn',  @OrientTuning_BAR_REPEAT_SPH_CHECK_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OrientTuning_BAR_REPEAT_SPH_CHECK is made visible.
function OrientTuning_BAR_REPEAT_SPH_CHECK_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to OrientTuning_BAR_REPEAT_SPH_CHECK (see VARARGIN)

% Choose default command line output for OrientTuning_BAR_REPEAT_SPH_CHECK
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes OrientTuning_BAR_REPEAT_SPH_CHECK wait for user response (see UIRESUME)
...
function varargout = OrientTuning_BAR_REPEAT_SPH_CHECK_OutputFcn(hObject, eventdata, handles) 
