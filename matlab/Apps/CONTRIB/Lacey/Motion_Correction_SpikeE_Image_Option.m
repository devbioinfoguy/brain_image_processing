function varargout = Motion_Correction_SpikeE_Image_Option(varargin)
% MOTION_CORRECTION_SPIKEE_IMAGE_OPTION apply motion correction algorithm imported
...
% Edit the above text to modify the response to help Motion_Correction_SpikeE_Image_Option

% Last Modified by GUIDE v2.5 04-Oct-2012 10:17:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Motion_Correction_SpikeE_Image_Option_OpeningFcn, ...
                   'gui_OutputFcn',  @Motion_Correction_SpikeE_Image_Option_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Motion_Correction_SpikeE_Image_Option is made visible.
function Motion_Correction_SpikeE_Image_Option_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Motion_Correction_SpikeE_Image_Option (see VARARGIN)
global SpikeMovieData;

% Choose default command line output for Motion_Correction_SpikeE_Image_Option
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Motion_Correction_SpikeE_Image_Option wait for user response (see UIRESUME)
...
function varargout = Motion_Correction_SpikeE_Image_Option_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    for i=1:MaxFrame
        ...
        SpikeMovieData(CurrentMovie).Movie(:,:,i)=cast(ImageOut-10,class(SpikeMovieData(CurrentMovie).Movie));
